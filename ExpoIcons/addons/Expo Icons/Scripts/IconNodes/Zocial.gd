...
const defaultIcon : String = "guest" ## Default Icon
const fontFile : FontFile = preload(_FONT_FOLDER + "Zocial.ttf") ## Used [FontFile]
const glyphs : Dictionary = preload(_GLYPHMAPS_FOLDER + "Zocial.json").data ## Used glyphs
