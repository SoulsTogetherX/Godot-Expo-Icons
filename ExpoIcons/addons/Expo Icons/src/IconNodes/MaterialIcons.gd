...
const fontFile : FontFile = preload(_FONT_FOLDER + "MaterialIcons.ttf") ## Used [FontFile]
const glyphs : Dictionary = preload(_GLYPHMAPS_FOLDER + "MaterialIcons.json").data ## Used glyphs
